...
def contain_security_incident(incident_type: str = None, affected_system: str = None, **kwargs) -> str:
    ...
    print(
        f"[TOOL] contain_security_incident(incident_type={incident_type}, affected_system={affected_system}, kwargs={kwargs})")
...
if __name__ == "__main__":
    ...
    convo = [HumanMessage(
        content="Hi, I'm John Smith, the new marketing manager. I need access to the shared marketing drive and Adobe Creative Suite.")]
