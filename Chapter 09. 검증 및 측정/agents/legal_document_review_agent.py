...
def track_deadlines(case_name: str = None, document_type: str = None, filing_deadline: str = None, **kwargs) -> str:
    ...
    print(
        f"[TOOL] track_deadlines(case_name={case_name}, document_type={document_type}, deadline={filing_deadline}, kwargs={kwargs})")
...
if __name__ == "__main__":
    example = {"matter_id": "MTR-12345", "client_id": "CLI-789", "matter_type": "contract_review",
               "attorney": "J. Smith"}
    convo = [HumanMessage(
        content="I need you to review this employment agreement for red flags. The client is concerned about the non-compete clause and termination provisions.")]
