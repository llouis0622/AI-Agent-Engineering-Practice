...
def increase_credit_limit(account_id: str, current_limit: str, requested_limit: str, **kwargs) -> str:
    ...
    print(
        f"[TOOL] increase_credit_limit(account_id={account_id}, current={current_limit}, requested={requested_limit})")
...
if __name__ == "__main__":
    ...
    convo = [HumanMessage(
        content="I think there's fraud on my account. I see a $2,500 charge in Miami but I'm in New York.")]
